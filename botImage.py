...
class BotImage:
    ...
    def create_image(self, text, subtext):
        ...
        font_size_text = 10 #70
        font_size_subtext = 10 #40
        max_width_text = (image.width - (image.width/2 - 310))//(font_size_text//2) - 1
        ...
        try:
            ...
            font_subtext = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf", font_size_subtext)
        except IOError:
...
#    bot = BotImage()
#    bot.create_image("O motivo é que estão metendo na tua ex pai, enfiando com tudo, a meta é ficar alegre pra pegar a ex de alguem e fazer o mesmo", "freireleo98, membro do fundao que teve a ex comida")
