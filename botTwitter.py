...
class BotTwitter:
    ...
    def process_content(self):
        try:
            ...
            if random_content:
                ...
                sleep(3)
                post_content_dir = "bot-cirurgico-twitter/createdImage" + "/" + create_filename(content_autor_subtext) + ".jpg"
    ...
    def __delete_image(image_filename):
        os.remove("bot-cirurgico-twitter/createdImage/" + image_filename + ".jpg")
